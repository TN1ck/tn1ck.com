  ...
  return (
    <Container activeId="projects">
      <div className="flex flex-col relative bg-slate-50 border-2 border-slate-900 p-6 py-8 mt-16">
        ...
        <div>
          This is a collection of personal projects I have worked on. They were
          all created out of fun, frustration or curiosity. I hope you enjoy
          them.
        </div>
        <div className="grid gap-8">
          ...
          >
            <p>
              ...
              is full featured sudoku app with a decently polished web UI. It
              has support for notes, hints, keyboard shortcuts, a timer that
              stops when the window loses focus, 100 sudokus for each of the
              difficulties and first class citizen support for desktop (mobile
              or mouse) and mobile. I started this project out of frustration
              for the available web options back then (2017), this has since
              then greatly improved. The project is{" "}
          ...
          >
            <p>
              ...
              advanced filtering feature, a bookmark functionality and a very
              nice glossary.
            </p>
          </ProjectComponent>
          <ProjectComponent
          ...
          >
            <p>
              ...
              was to combine the immense search space of an anagram generator
              with a nice and fast UI. Using Mobx, webworkers and React this
              goal was achieved.
            </p>
          </ProjectComponent>
          <ProjectComponent
          ...
          >
            ...
            is a small little game, where you have to recognize a Pokémon with
            its GameBoy sound. I originally created it as a gift, but then we
            polished it a bit and released it. It was initially released on{" "}
            ...
            where he played the game, afterwards a lot of other YouTubers
            followed suit and also did the Pokémon Cry Challenge. It is really
            nice to see how much people seem to enjoy this small little game and
            how it went viral in a small circle of Pokémon players.
          </ProjectComponent>
          <ProjectComponent
            project={{
              title: "Pixel OCD",
          ...
          >
            <p>
              ...
              sometimes I have to turn it up when it is really bright outside.
              It was my first Swift/C project for macOs. Despite being a
              protoype, I still use it often und it works flawlessly. It is
              using the{" "}
              <a
                className="link"
          ...
          >
            ...
            them for a robotics project, and there was not a resource available
            to print specific markers and a lot of them, so I created this small
            page.
          </ProjectComponent>
          <ProjectComponent
            project={{
          ...
          >
            I wrote my bachelor thesis for the DAI Laboratory. It is used there
            as a social search engine. One can query their search engine and
            ...
            actions immediately affected the global leaderboard and score, so
            the application could be used to shown on an office screen. The
            layout engine of the application was written by me, as well as all
            other things. The technologies used were exclusively lower level
            things like react, reflux, lodash.
          ...
          >
            ...
            , the JavaScript version of Processing. I actually wanted to make
            one sketch per week, but this did not really work out. The coolest
            sketch is probably the tree generator, as the trees look really
            realistic.
          </ProjectComponent>
        </div>
      </div>
