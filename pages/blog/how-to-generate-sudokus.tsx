      ...
      <BlogContent metadata={metadata}>
        ...
        {/* While writing a Sudoku Solver is a
          ...
          <a href="https://www.bbc.com/news/technology-32591984">
            Singapore's prime minister famously wrote one in C++
          </a>
          . */}
        <p>
          First things first, to generate a Sudoku, we first have to solve one.
          The solver plays an integral part in the generation part, as we will
  ...
  return []
        ...
        <div>
          <Card title="Skip on invalid Sudokus">
            <div className="mb-8">
              The simplest and most substantial change we can do is not waiting
              until the whole Sudoku is filled but skipping on the Sudokus that
              are already invalid. This solver will solve even the hardest
              Sudokus in adequate time, but it still wastes a lot of cycles as
              it is not choosing the cell to fill with a value with any
              strategy.
            </div>
  ...
  return []
        ...
        <Card title="Minimum remaining value">
          <div className="mb-8">
            ...
            work on the cells with the least options. This greatly reduces the
        ...
        <Card title={"Arc Consistency"}>
          ...
          <ul className="blog">
            ...
            <li>
              ...
              variables are the cells, the domains are the numbers 1 - 9, and
              the constraints are that every row, column, and square has to have
              unique numbers.
            </li>
            <li>
          ...
          <p>
            ...
            constraints e.g. remove the numbers that are already in the same
            row/column/square. We do this as long until no domain is changing
          ...
          <p>
            ...
            again to select the cell with the least options and create new
          ...
          <p>
            ...
            unfilled cells. If a Sudoku cannot be solved, one domain will become
            empty, which is shown as red, then the algorithm will backtrack.
          </p>
          <SudokuApplet
            showNotes={true}
...
`}</CodeBlock>
        ...
        <p>
          We will do basically the same, but actually publish the data and also
          try out how the "lesser" strategies work here for rating the
        ...
        <h3>How well do the solvers measure human difficulty?</h3>
        <p>
        ...
        <p>
          ...
          compute even medium difficult Sudokus.
        </p>
        <p>
          <strong>
          ...
          currently known algorithms to solve an NP-hard problem take
          exponential time.
        </p>
        <Card title={"Histograms"}>
          <div className="mb-4">
            First let's draw a histogram of each strategy and each dataset to
            get an idea of the distribution. From that, we can see that they
            seem to be more or less normally distributed (with the applied
        ...
        <Card title={"QQ plots"}>
          <div className="mb-4">
            ...
            understanding of how the values are distributed. A perfect normal
        ...
        <Card title="Correlation">
          ...
          <p>
            ...
            force having a perfect 1.0 correlation, making it highly likely that
            the websites use the iteration count as well for their level
            ...
            an exercise for the reader (Sorry I'm not paid for this.)
          </p>
        </Card>
        ...
        <Card title="Generating a Sudoku with a specific difficulty">
          ...
          <ol className="blog">
            ...
            <li>
              ...
              numbers or add numbers until the reached difficulty is achieved.
            </li>
            <li>
          ...
          <p>
            As point 3 points out, generating very difficult Sudokus can take
            quite some time as any generation method will struggle with the
            uniqueness constraint and has to randomly alter the Sudoku
            generation steps. Here is an applet for you to interactively run the
            Sudoku. The code is not crazy optimized, and we do have to do some
            heavy calculations,{" "}
            <strong>
        ...
        <blockquote>
          ...
          accept the second puzzle as the new solution and otherwise, we undo
          the change. We do this process until meeting the stopping criterion.
          <br />
          The cost function for a given puzzle is infinity for puzzles with none
          or more than one solution. For other puzzles, the cost is the absolute
          value of the current puzzle’s call count minus the average call count
          of the given difficulty level. For example, if we want to generate an
          easy puzzle and we want to consider the values demonstrated in Table
          I, then the cost function for a puzzle having a unique solution is the
          absolute value of its call count minus 6.234043.
          <br />
        ...
        <p>
          ...
          in a valid configuration before.
        </p>
        <p>
          I find my algorithm to be more efficient and elegant as it is guided
          by the Sudoku's constraints, namely we first create a solvable and
